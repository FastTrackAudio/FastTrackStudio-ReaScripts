...
function PushTheme()
    ...
    reaper.ImGui_PushStyleColor(ctx, reaper.ImGui_Col_Button(),            0x2F76F0F0)
    reaper.ImGui_PushStyleColor(ctx, reaper.ImGui_Col_ButtonHovered(),     0x2F76F0F0)
    reaper.ImGui_PushStyleColor(ctx, reaper.ImGui_Col_ButtonActive(),      0x2F76F0F0)
